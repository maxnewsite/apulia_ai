    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="max-w-xl mx-auto text-[#94A3B8] text-lg">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-4xl mx-auto">
          {/* Weekly — free */}
          <article
            className="relative flex flex-col rounded-2xl bg-[#0F1A2E] border border-[#1E3A5F] p-8 hover:border-[#2563EB]/50 transition-all duration-300 group"
          ...
          >
            ...
            <div className="mb-5 flex items-center justify-between">
              ...
              <span className="text-sm text-[#94A3B8] font-medium">{weekly.frequency}</span>
            </div>

            {/* Name & description */}
            <h3 className="text-xl font-black text-[#F0F4FF] mb-2 group-hover:text-white transition-colors">
              {weekly.name}
            </h3>
            ...
            <div className="mt-auto">
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-2xl font-black text-[#F0F4FF]">{weekly.price}</span>
              </div>
              <a
                href="#subscribe"
                className="block w-full text-center px-6 py-3 rounded-xl bg-[#2563EB] text-white font-semibold text-sm hover:bg-[#1D4ED8] active:scale-[0.98] transition-all duration-200 shadow-md shadow-[#2563EB]/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0F1A2E]"
              >
                {weekly.cta}
              </a>
            </div>
          ...
          {/* Monthly — premium */}
          <article
            className="relative flex flex-col rounded-2xl bg-[#0F1A2E] border border-[#F59E0B]/30 p-8 hover:border-[#F59E0B]/60 transition-all duration-300 group glow-border"
          ...
          >
            ...
            <div className="mb-5 flex items-center justify-between">
              ...
              <span className="text-sm text-[#94A3B8] font-medium">{monthly.frequency}</span>
            </div>
            ...
            <div className="mt-auto">
              <div className="flex items-baseline gap-1 mb-1">
                <span className="text-2xl font-black text-[#F0F4FF]">{monthly.price}</span>
              </div>
              <p className="text-xs text-[#F59E0B]/70 mb-4 font-medium">{monthly.priceNote}</p>
              <a
                href="#subscribe"
                className="block w-full text-center px-6 py-3 rounded-xl bg-[#F59E0B]/10 text-[#F59E0B] font-semibold text-sm border border-[#F59E0B]/30 hover:bg-[#F59E0B]/20 hover:border-[#F59E0B]/60 active:scale-[0.98] transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#F59E0B] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0F1A2E]"
              >
                {monthly.cta}
              </a>
            </div>
