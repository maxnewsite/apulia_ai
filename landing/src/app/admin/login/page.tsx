  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#0D1828] border border-[#E2E8F0] rounded-2xl p-8">
          <h1 className="text-xl font-bold text-white mb-1">Accesso Admin</h1>
          <p className="text-sm text-[#475569] mb-6">Area riservata</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                autoComplete="email"
                className="w-full bg-[#071020] border border-[#E2E8F0] rounded-lg px-4 py-2.5 text-white text-sm placeholder-[#E2E8F0] focus:outline-none focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB] transition"
