    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 pt-24 md:pt-32 pb-16">
        ...
        >
          ...
          <span className="text-[#0F172A]">Archivio Weekly</span>
        </nav>
        ...
        <header className="mb-12 pb-8 border-b border-[#E2E8F0]">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-[#0F172A] leading-tight mb-4">
            Archivio edizioni
          </h1>
        ...
        <aside className="mt-16 p-8 md:p-10 bg-gradient-to-br from-[#F8FAFC] to-[#FFFFFF] border border-[#E2E8F0] rounded-2xl text-center">
